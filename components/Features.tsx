...
const features = [
  {
    ...
    icon: <SealCheck size={30} className='text-blue-930' />
  },
  {
    id: 2,
    ...
    icon: <Heart size={30} className='text-blue-930' />
  },
  {
    id: 3,
    ...
    icon: <PiggyBank size={30} className='text-blue-930' />
  },
  {
    id: 4,
    ...
    icon: <Headset size={30} className='text-blue-930' />
  },
  {
    id: 5,
    ...
    icon: <CloudArrowDown size={30} className='text-blue-930' />
  },
  {
    id: 6,
    ...
    icon: <Smiley size={30} className='text-blue-930' />
  },
  {
    id: 7,
  ...
  return (
    <section className="flex flex-col w-full h-full px-2 py-6">
      <div className="flex flex-row flex-wrap justify-start gap-4">
       {
        features.map((item) => (
          <Card className="w-[320px] h-[230px] bg-slate-50 border-none flex flex-col justify-start items-center shadow-2xl gap-2" key={item.id}>
